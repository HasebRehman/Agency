...
export default function Home() {
  return (
    <main className="relative flex flex-col w-full min-h-screen bg-black overflow-x-hidden">
      ...
      {/* 3D Stars background — fixed overlay spanning both sections */}
      <ThreeDStars />
      ...
      */}
      <div id="hero-scroll-container">
        ...
        <section id="hero-section" className="relative flex h-[100vh] w-full flex-col justify-center items-center bg-transparent px-6 overflow-hidden z-10">
        ...
        <section id="about-section" className="relative flex h-[100vh] w-full flex-col justify-center items-center bg-transparent px-6 z-10">
